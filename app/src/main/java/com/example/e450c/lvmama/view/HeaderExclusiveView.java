...
public class HeaderExclusiveView extends HeaderViewInterface<List<HomeVirticalAdEntity>> {
...
//    VerticalBannerView verticalBannerView;
    ...
    public HeaderExclusiveView(Activity context) {
        super(context);
    }

    @Override
    protected void getView(List<HomeVirticalAdEntity> homeVirticalEntities, ListView listView) {
        View view = mInflate.inflate(R.layout.header_phone_exclusive_layout,listView,false);
